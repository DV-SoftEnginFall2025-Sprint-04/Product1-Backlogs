...
| LC-005 | As a developer, I want to design a basic homepage with project title and purpose to confirm frontend setup. | 5 | 1 | N | Assigned | Diego |
...
| LC-033| As a  developer, I want to add a loading spinner to show while calendar data is being fetched.        | 6                   | 2                 | N   | Assigned    |Sai Viha              |
