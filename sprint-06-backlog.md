...
permalink: /sprint-06-backlog/
---

# 📋 Sprint 06 Backlog – *LewisCal*

Scrum Master: Ilias Yeck

Product Owner: Diego Velasco

Sprint 6 Planning Date/Time: ov 2nd, 2025 - Nov 16th, 2025

Sprint 6 Planning Participants: Diego Velasco, Jayson Matula, Ilias Yeck, Sai Vihas Yadav
...
| LC-003 | As a developer, I want to install and configure Node.js and Express for the backend server. | 9 | 6 | N | Done | Jayson |
...
| LC-023 | As a user, I want the product's "credits" page to have the contact information of the developers if I need to contact them. | 3 | 2 | N | Done | Jayson |
...
| LC-026 | As a developer, I want to ensure that I am able to implement development to the product. | 6 | 2 | N | Done | Jayson |
