...
permalink: /sprint-07-backlog/
---

# 📋 Sprint 07 Backlog – *LewisCal*
...
| LC-036 | As a user, I want a loading indicator while my calendar imports so I know the system is working. | 6 | 1 | N | Planned |  |
...
| LC-042 | As a user, I want to transition all product assets. | 9 | 5 | Y | Assigned  | Ilias |
| LC-043 | As a user, I want to transition all product assets. | 9 | 5 | Y | Assigned  | Jayson |
| LC-044 | As a user, I want to transition all product assets. | 9 | 5 | Y | Assigned  | Sai Vihas |
| LC-045 | As a user, I want to prepare for the Class Product Presentation. | 9 | 5 | N | Assigned  | Diego |
